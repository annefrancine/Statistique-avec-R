...
# La fonction by() permet d'appliquer un calcul en fonction des catégories d'une ou plusieurs colonne
data(iris)
View(iris)
by(iris[,1],iris[,5],mean) # Faire la moyenne de iris[,1] en fonction des catégories de iris[,5]

# Fusionner des tableaux
# merge() permet des fusions de tableaux selon des critères et des dimensions
